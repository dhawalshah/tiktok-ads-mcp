...
**Date:** 2026-04-08
**Status:** Approved
**Target endpoint:** `https://tiktok-mcp-YOUR_PROJECT_NUMBER.asia-southeast1.run.app/mcp`
...
- Google Analytics: `ga-mcp-YOUR_PROJECT_NUMBER.asia-southeast1.run.app/mcp`
- Google Ads: `ads-mcp-YOUR_PROJECT_NUMBER.asia-southeast1.run.app/mcp`
- Meta Ads: `fb-ads-mcp-YOUR_PROJECT_NUMBER.asia-southeast1.run.app/sse`
- LinkedIn Ads: `li-ads-mcp-YOUR_PROJECT_NUMBER.asia-southeast1.run.app/mcp`
...
Google Cloud Run (asia-southeast1)
  tiktok-mcp-YOUR_PROJECT_NUMBER
        │
        ▼
